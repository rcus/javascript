...
$(document).ready(function(){
  ...
  var t1 = document.getElementById('b1'),
    ...
    tSomersault = document.getElementById('b-somersault');
  
  t1.swap = t2.swap = t3.swap = t4.swap = t5.swap = t6.swap = t7.swap = t8.swap = tSomersault.swap = 1;
  ...
  tSomersault .onclick = function() { this.className = (this.swap++ % 2) ? 'baddie somersault' : 'baddie'; };
